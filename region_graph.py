...
class RegionGraph(object):
    ...
    def InitDistanceDict(self):
        ...
        :rtype: list"""
#        dico_liste = []
#        dico = {"r1": None, "neighbours": []}
#        for node in self.region_list:
#            dico = {"r1": node, "neighbours": []}
#            for neighbour in node.neighbours:
#                dico["neighbours"].append(tuple([neighbour, abs(node.val - neighbour.val)]))
#            dico_liste.append(dico)
#        return dico_liste
        list_dict = []
...
#                if r2[1] < dmin:
#                    dmin = r2[1]
#                    dico_min = {"r1": r1["r1"], "r2": r2[0], "val": dmin}
#                else :
#                    dmin = dmin
#                    dico_min = dico_min
#        return dico_min
